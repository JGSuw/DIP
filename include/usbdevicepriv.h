...
//
//*****************************************************************************
extern tBoolean USBDeviceConfig(uint32_t ulIndex,
                                const tConfigHeader *psConfig,
                                const tFIFOConfig *psFIFOConfig);
extern tBoolean USBDeviceConfigAlternate(uint32_t ulIndex,
                                         const tConfigHeader *psConfig,
                                         uint8_t ucInterfaceNum,
                                         uint8_t ucAlternateSetting);
extern void USBDeviceResumeTickHandler(uint32_t ulIndex);
