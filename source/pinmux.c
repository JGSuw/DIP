...
/* USER CODE END */
    ...
    pinMuxReg->PINMMR4 = PINMUX_BALL_M1_GIOA_7 | PINMUX_BALL_V2_EQEP2A | PINMUX_BALL_U1_EQEP2B;
    ...
    pinMuxReg->PINMMR9 = ((~(pinMuxReg->PINMMR9 >> 18U) & 0x00000001U ) << 18U) | PINMUX_BALL_W9_EQEP1B | PINMUX_BALL_V10_EQEP1I | PINMUX_BALL_J3_MIBSPI1NCS_3;
    ...
    pinMuxReg->PINMMR19 = PINMUX_BALL_B11_EQEP2S;
    
    pinMuxReg->PINMMR20 = PINMUX_BALL_F3_EQEP1S;
    ...
    pinMuxReg->PINMMR31 = 0x00000101U;
    
    pinMuxReg->PINMMR32 = 0x01010101U;

    pinMuxReg->PINMMR33 = PINMUX_BALL_B12_HET1_04 | PINMUX_BALL_V8_MIBSPI3SOMI | PINMUX_BALL_W8_MIBSPI3SIMO | PINMUX_BALL_V9_EQEP1A;
